...
private:
  ...
  MsgStatus status;
public:
  testRemetStatus(const std::string& R, MsgStatus S);
...
private:
  ...
  int32_t id;
public:
  testRemetId(const std::string& R, int32_t I);
  friend class Mensagem;
};
...
private:
  ...
  MsgStatus status;
public:
  testDestStatus(const std::string& D, MsgStatus S);
  friend class Mensagem;
};
...
private:
  ...
  int32_t id;
public:
  testDestId(const std::string& D, int32_t I);
  friend class Mensagem;
};
