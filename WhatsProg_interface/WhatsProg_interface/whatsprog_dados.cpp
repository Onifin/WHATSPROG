...
testRemetStatus::testRemetStatus(const string& R, MsgStatus S): remetente(R), status(S) {}

/// Testar mensagens com um dado remetente e id
testRemetId::testRemetId(const string& R, int32_t I): remetente(R), id(I) {}

/// Testar mensagens com um dado destinatario e status
testDestStatus::testDestStatus(const string& D, MsgStatus S): destinatario(D), status(S) {}

/// Testar mensagens com um dado destinatario e id
testDestId::testDestId(const string& D, int32_t I): destinatario(D), id(I) {}
