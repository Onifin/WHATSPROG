    ...
    case mysocket_status::SOCK_OK:
      ...
      case CMD_NOVA_MSG:
        ...
        try
        {
          ...
          if (it == DC.end()) // Nao existia conversa com esse remetente
          {
            ...
            if (!DC.insertConversa(remetente)) throw 4;
          ...
          if (!M.setId(id) ||
              ...
              !M.setTexto(texto) ||
              !M.setStatus(MsgStatus::MSG_ENTREGUE)) throw 5;
      ...
      case CMD_MSG_ENTREGUE:
        ...
        try
        {
          ...
          // Testa o remetente
          if (it->getMensagem(ind_msg).getRemetente()!=DC.getMeuUsuario()) throw 3;

          // Testa o status atual da msg
          if (cmd==CMD_MSG_RECEBIDA)
          {
            if (it->getMensagem(ind_msg).getStatus()!=MsgStatus::MSG_ENVIADA) throw 4;
          ...
          {
            if (it->getMensagem(ind_msg).getStatus()!=MsgStatus::MSG_RECEBIDA) throw 5;
      ...
      case CMD_MSG_INVALIDA:
        ...
        try
        {
          ...
          if (it->getMensagem(ind_msg).getRemetente()!=DC.getMeuUsuario() ||
              it->getMensagem(ind_msg).getStatus()!=MsgStatus::MSG_ENVIADA) throw 3;
